...
```
cd existing_repo
git remote add origin https://git.asseco-see.hr/all-projects/asseco-see-hrvatska/security-and-compliance/products/mobile-development/hr.asee.android.licensing.sdk.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.asseco-see.hr/all-projects/asseco-see-hrvatska/security-and-compliance/products/mobile-development/hr.asee.android.licensing.sdk/-/settings/integrations)
